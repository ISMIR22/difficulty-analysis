...
class DeepGRU(nn.Module):
    def __init__(self, num_features, num_classes, representation_type, device=None, representation=None):
        ...
        self.gru_fng_exp = nn.GRU(input_size_gru, 128, 4, dropout=0.9, batch_first=True)
...
def attention():
    ...
    train_loader, val_loader, test_loader, test_full_loader, test_split_loader, weight_class = create_dataset_henle_full(subset_type="full", representation=sys.argv[2])
    # pdb.set_trace()≤
